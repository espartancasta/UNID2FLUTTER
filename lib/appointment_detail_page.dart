...
/// ------------------------------------------------------
/// 🔹 FORMULARIO DE CREAR/EDITAR CITAS (CON PICKER DE MÉDICOS)
/// ------------------------------------------------------
...
class _CreateEditAppointmentPageState extends State<CreateEditAppointmentPage> {
  ...
  void initState() {
    ...
    // Si vienes editando, intenta emparejar el doctor actual con la lista
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildDoctorField(), // ← campo médico con dropdown
  ...
  /// 🔹 Campo de médico con DropdownButtonFormField
  Widget _buildDoctorField() {
    return DropdownButtonFormField<Doctor>(
      value: _selectedDoctor,
      dropdownColor: const Color(0xFF151531),
  ...
  /// ListTile para seleccionar fecha/hora
